<?php if (empty($_POST["publi"])) {
    ...
    <form class="" action="#" method="post">
        ...
        <textarea class="form-control" id="ennonceExam"  onkeyup="adjustHeightTextArea(this)" name="publi" placeholder='Veuillez écire vos variables de la manière suivante : [["maVariable"]]'></textarea>
